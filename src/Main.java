...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            insertContact(statement, "Eli", 123456, "eli@email.com");
            insertContact(statement, "Iza", 987, "iza@email.com");
            insertContact(statement, "Bon", 54654, "bon@email.com");
            insertContact(statement, "Lin", 932100, "lin@email.com");
